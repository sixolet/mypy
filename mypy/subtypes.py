...
def is_callable_subtype(left: CallableType, right: CallableType,
    ...
    for i in range(len(right.arg_types)):
        ...
        if (left_by_name is not None
            ...
            if (left_by_position[3] == False and left_by_name[3] == False
                and left_by_position[0] == None and left_by_name[1] == None
                and left_by_position[2] == left_by_name[2]
            ):
                left_name = left_by_name[0]
                left_position = left_by_position[1]
                left_type = left_by_position[2]
                left_required = False
            else:
                return False
        else:
